    ...
    <div className="min-h-screen relative overflow-hidden flex items-center justify-center px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
      ...
      <div className="max-w-md w-full relative z-10">
        ...
        <div className="text-center mb-6 sm:mb-8">
          ...
          <p className="text-white text-sm sm:text-base opacity-80">Sign in with email address</p>
        </div>
        ...
        <div className="bg-purple-900 bg-opacity-40 backdrop-blur-md rounded-2xl sm:rounded-3xl shadow-2xl p-6 sm:p-8 border border-purple-500 border-opacity-30">
          <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
            ...
            {/* Success Message */}
            {success && (
              <div className="bg-green-500 bg-opacity-90 border-l-4 border-green-700 p-4 rounded-xl">
          ...
          <div className="mt-4 sm:mt-6 text-center">
            <p className="text-white text-sm sm:text-base font-medium opacity-80">
              ...
              <a href="/signup" className="text-cyan-400 font-bold hover:text-cyan-300 underline decoration-2 underline-offset-4 transition-colors duration-200">
                Sign up here
              </a>
            </p>
          </div>
        ...
        <div className="mt-6 sm:mt-8 text-center px-4">
          <h2 className="text-white text-xl sm:text-2xl lg:text-3xl font-bold mb-2">
            SIGN IN TO YOUR <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-purple-400">ADVENTURE!</span>
          </h2>
        </div>
      </div>
    </div>
